...
<script src="<?php echo base_url()  ?>assets/ckeditor/sample.js"></script>
    ...
    <input type="hidden" name="gallery_id" value="<?php echo !empty($dbData['id'])?$dbData['id']:''; ?>" />
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <img id="blah" src="<?php if(!$dbData['image']==""){echo '../uploads/gallery/'.$dbData['image'];}else{echo '../assets/img/default.jpg';}?>" class="img-thumbnail" width="125" height="100">
    </div>
