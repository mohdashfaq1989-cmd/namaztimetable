                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <a  href="<?php echo base_url('gallery/add'); ?>" class="btn btn-primary">Add <?php echo $page_title; ?></a>
                                </div>
                                        ...
                                        <tbody> 
							                 <?php if(!empty($gallery)){ $i=0;  
							                    foreach($gallery as $row){ $i++; 
							                        $image = !empty($row['image'])?'<img src="'.base_url().'../uploads/gallery/'.$row['image'].'" alt="" style="width:80px"/>':''; 
							                        $statusLink = ($row['status'] == 1)?site_url('gallery/block/'.$row['id']):site_url('gallery/unblock/'.$row['id']);  
							                ...
							                <tr>
							                    ...
							                    <td>
							                        <a href="<?= base_url('gallery/edit/'.$row['id']) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
            ...
            $.ajax({    
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            $('#modal_msg').html('Gallery deleted Successfully').css('color','green');
                            setTimeout(function(){
                                $('#modal_msg').html('');
                                location.reload();
                            },1000)
