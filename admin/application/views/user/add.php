...
<script src="<?php echo base_url()  ?>assets/ckeditor/sample.js"></script>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input name="name" class="form-control" type="text" placeholder="Enter Name" id="title" value="" />
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input name="password" class="form-control" type="text" placeholder="Enter Password" id="password" value="" />
        </div>
    </div>
    <div class="form-group row">
