                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <a  href="<?php echo base_url('states/add'); ?>" class="btn btn-primary">Add <?php echo $page_title; ?></a>
                                </div>
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" 
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('states/edit/'.$row['state_id']) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                    <a class="btn btn-danger dataDelete" data-type="user" data-id="<?= $row['state_id'] ?>" data-name="<?= $row['state_name']?>" href="javascript:;"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }else{ ?>
...
<div class="modal fade" id="DeleteModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).ready(function(){ 
        $(document).delegate('.deleteUser', 'click', function () {
            ...
            console.log('modal')
            $.ajax({    
                     url:"<?php echo base_url(); ?>states/deleteStates",       
                     method:"POST",  
                     data:{
                         state_id:state_id,
                     },    
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            $('#modal_msg').html('State deleted Successfully').css('color','green');
                            setTimeout(function(){
                                $('#modal_msg').html('');
                                location.reload();
                            },1000)
