...
<script src="<?php echo base_url()  ?>assets/ckeditor/sample.js"></script>
    ...
    <input type="hidden" name="state_id" value="<?php echo !empty($dbData['state_id'])?$dbData['state_id']:''; ?>" />
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input name="state_name" class="form-control" type="text" placeholder="State Name" id="state_name" value="<?php echo !empty($dbData['state_name'])?$dbData['state_name']:''; ?>" />
        </div>
    </div>
	...
	$(document).ready(function(){
        ...
        $('#insertUserData').on('submit', function(e){  
            ...
            $.ajax({    
                     url:"<?php echo base_url(); ?>states/edit_states/",    
                     method:"POST",  
                     data:formData,  
                     beforeSend: function() {
