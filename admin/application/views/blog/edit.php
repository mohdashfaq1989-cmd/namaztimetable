...
<script src="https://cdn.ckeditor.com/4.22.1/standard/ckeditor.js"></script>
    ...
    <input type="hidden" name="blog_id" value="<?php echo !empty($dbData['id'])?$dbData['id']:''; ?>" />

    <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label">Title</label>
        <div class="col-sm-9">
            <input name="title" class="form-control" type="text" placeholder="Title" id="title" value="<?php echo !empty($dbData['title'])?$dbData['title']:''; ?>" />
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea name="description" placeholder="Description" class="form-control" id="description"><?php echo !empty($dbData['description'])?$dbData['description']:''; ?></textarea>
        </div>
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <img id="blah" src="<?php if(!$dbData['image']==""){echo '../uploads/blog/'.$dbData['image'];}else{echo '../assets/img/default.jpg';}?>" class="img-thumbnail" width="125" height="100">
    </div>
