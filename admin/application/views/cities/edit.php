...
<script src="<?php echo base_url()  ?>assets/ckeditor/sample.js"></script>
    ...
    <input type="hidden" name="city_id" value="<?php echo !empty($dbData['city_id'])?$dbData['city_id']:''; ?>" />
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input name="city_name" class="form-control" type="text" placeholder="City Name" id="city_name" value="<?php echo !empty($dbData['city_name'])?$dbData['city_name']:''; ?>" />
        </div>
    </div>
	...
	$(document).ready(function(){
        ...
        $('#insertUserData').on('submit', function(e){  
            ...
            $.ajax({    
                     url:"<?php echo base_url(); ?>cities/edit_cities/",    
                     method:"POST",  
                     data:formData,  
                     beforeSend: function() {
