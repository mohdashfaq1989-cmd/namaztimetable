                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <a  href="<?php echo base_url('countries/add'); ?>" class="btn btn-primary">Add <?php echo $page_title; ?></a>
                                </div>
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" 
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone,tablet">country Code</th>
                                        ...
                                        <tbody> 
							                ...
							                <tr>
							                    ...
							                    <td>
							                        <a href="<?= base_url('countries/edit/'.$row['country_id']) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
							                        <a class="btn btn-danger dataDelete" data-type="user" data-id="<?= $row['country_id'] ?>" data-name="<?= $row['country_name']?>" href="javascript:;"><i class="fa fa-trash-o"></i></a>
							                    </td>
							                </tr>
							                <?php } }else{ ?>
...
<div class="modal fade" id="DeleteModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).ready(function(){ 
        $(document).delegate('.deleteUser', 'click', function () {
            ...
            console.log('modal')
            $.ajax({    
                     url:"<?php echo base_url(); ?>countries/deleteCountries",       
                     method:"POST",  
                     data:{
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            $('#modal_msg').html('Country deleted Successfully').css('color','green');
                            setTimeout(function(){
                                $('#modal_msg').html('');
                                location.reload();
                            },1000)
