...
<script src="<?php echo base_url()  ?>assets/ckeditor/sample.js"></script>
    ...
    <input type="hidden" name="tehsil_id" value="<?php echo !empty($dbData['tehsil_id'])?$dbData['tehsil_id']:''; ?>" />
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input name="tehsil_name" class="form-control" type="text" placeholder="Tehsil Name" id="tehsil_name" value="<?php echo !empty($dbData['tehsil_name'])?$dbData['tehsil_name']:''; ?>" />
        </div>
    </div>
	...
	$(document).ready(function(){
        ...
        $('#insertUserData').on('submit', function(e){  
            ...
            $.ajax({    
                     url:"<?php echo base_url(); ?>tehsil/edit_tehsil/",    
                     method:"POST",  
                     data:formData,  
                     beforeSend: function() {
