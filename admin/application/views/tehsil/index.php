                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <a  href="<?php echo base_url('tehsil/add'); ?>" class="btn btn-primary">Add <?php echo $page_title; ?></a>
                                </div>
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" 
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone,tablet">Country Name</th>
                                                <th data-hide="phone,tablet">State Name</th>
                                                <th data-hide="phone,tablet">District Name</th>
                                                <th data-hide="phone,tablet">Tehsil Name</th>  
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td> 
                                                <td><?php echo $this->db->get_where('countries',array('country_id' => $row['country_id']))->row('country_name'); ?></td>
                                                <td><?php echo $this->db->get_where('states',array('state_id' => $row['state_id']))->row('state_name'); ?></td>
                                                <td><?php echo $this->db->get_where('cities',array('city_id' => $row['city_id']))->row('city_name'); ?></td>
                                                <td><?php echo $row['tehsil_name']; ?></td> 
                                                <td>
                                                    <a href="<?= base_url('tehsil/edit/'.$row['tehsil_id']) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                    <a class="btn btn-danger dataDelete" data-type="user" data-id="<?= $row['tehsil_id'] ?>" data-name="<?= $row['tehsil_name']?>" href="javascript:;"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }else{ ?>
...
<div class="modal fade" id="DeleteModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).ready(function(){ 
        $(document).delegate('.deleteUser', 'click', function () {
            ...
            console.log('tehsil_id',tehsil_id); 
            console.log('modal')
            $.ajax({    
                     url:"<?php echo base_url(); ?>tehsil/deleteTehsil",       
                     method:"POST",  
                     data:{
                         tehsil_id:tehsil_id,
                     },    
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            $('#modal_msg').html('Tehsil deleted Successfully').css('color','green');
                            setTimeout(function(){
                                $('#modal_msg').html('');
                                location.reload();
                            },1000)
