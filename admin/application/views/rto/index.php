                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <a  href="<?php echo base_url('rto/add'); ?>" class="btn btn-primary">Add <?php echo $page_title; ?></a>
                                </div>
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" 
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone,tablet">Rto Name</th>  
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('rto/edit/'.$row['rto_id']) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                    <a class="btn btn-danger dataDelete" data-type="user" data-id="<?= $row['rto_id'] ?>" data-name="<?= $row['rto_name']?>" href="javascript:;"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }else{ ?>
...
<div class="modal fade" id="DeleteModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).ready(function(){ 
        $(document).delegate('.deleteUser', 'click', function () {
            var rto_id = $(this).data('id');
            console.log('rto_id',rto_id); 
            console.log('modal')
            $.ajax({    
                     url:"<?php echo base_url(); ?>rto/deleteRto",       
                     method:"POST",  
                     data:{
                         rto_id:rto_id,
                     },    
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            $('#modal_msg').html('Rto deleted Successfully').css('color','green');
                            setTimeout(function(){
                                $('#modal_msg').html('');
                                location.reload();
                            },1000)
