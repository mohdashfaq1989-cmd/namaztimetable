...
class Cities extends CI_Controller { 
    ...
    public function index(){ 
        ...
        $data['result'] = $this->cities_model->getRows(); 
    ...
    public function edit($id){
        ...
        $imgData = $this->db->get_where('cities',array('city_id' => $id))->row_array();  
    ...
    public function add_cities(){  
        ...
        $insertData = $this->db->insert('cities',$formData);
        if($insertData)
        {
    ...
    public function edit_cities(){ 
        ...
        $updateData = $this->db->update('cities',$formData,array('city_id'=>$city_id));
        if($updateData)
        {
            $response = array('status'=>1);
        }
    ...
    public function deleteCities(){
        $city_id = $this->input->post('city_id');
        $delete = $this->db->delete('cities', array('city_id'=>$city_id));
        if($delete)
        {
            $response = array('status'=>1);
        }
    ...
    public function delete($id){ 
        ...
        if($id){ 
            $con = array('id' => $id); 
            $imgData = $this->cities_model->getRows($con); 
            ...
            if($delete){ 
                ...
                $this->session->set_userdata('success_msg', 'cities has been removed successfully.'); 
            }else{ 
