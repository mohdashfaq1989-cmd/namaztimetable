	...
	function build_admin_tree(&$tree)
	{
		...
		if ( ! empty($tree))
		{
			foreach ($tree as &$leaf)
			{
				...
				{
					$output .= '<li id="list_' . $leaf['id'] . '"><div><i class="fa fa-arrows"></i> ' . $leaf['name'] . '<span><a class="btn btn-primary btn-mini" href="' . site_url('al/edit/' . $leaf['id']) . '"><i class="icon-pencil icon-white"></i> Edit</a> <a class="btn btn-danger btn-mini delete" data-toggle="modal" data-type="item" data-href="' . site_url('al/delete/' . $leaf['id']) . '" data-name="' . $leaf['name'] . '" href="javascript:;"><i class="icon-trash icon-white"></i> Delete</a></span></div>';
					$output .= '<ol>' . build_admin_tree($leaf['children']) . '</ol>';
					$output .= '</li>';
				}
				else
				{
					$output .= '<li id="list_' . $leaf['id'] . '"><div><i class="fa fa-arrows"></i> ' . $leaf['name'] . '<span><a class="btn btn-primary btn-mini my_btn" href="' . site_url('al/edit/'.$leaf['id']) . '"><i class="icon-pencil icon-white"></i> Edit</a> <a class="btn btn-danger btn-mini my_btn delete" data-toggle="modal" data-type="item" data-href="' . site_url('al/delete/' . $leaf['id']) . '" data-name="' . $leaf['name'] . '" href="javascript:;"><i class="icon-trash icon-white"></i> Delete</a></span></div></li>';
				}
			}
		}
