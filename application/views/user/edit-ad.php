...
<!-- MAIN CONTENT -->
        ...
        <div class="col-lg-10">
            ...
            <div class="form-group row">
                <input type="hidden" name="ad_id" value="<?php echo !empty($dbData->id)?$dbData->id:''; ?>" />
                ...
                <div class="col-sm-12">
                    ...
                    <input name="title" class="form-control" type="text" placeholder="Title" value="<?php echo !empty($dbData->title)?$dbData->title:''; ?>" />
                </div> 
                
                <div class="col-sm-12">
                    <label for="description" class="col-form-label">Description</label>
                    <textarea rows="10" name="description" placeholder="Description" class="form-control" id="description"><?php echo !empty($dbData->description)?$dbData->description:''; ?></textarea>
                </div>
	...
	$(document).ready(function(){
        ...
        $('#adForm').on('submit', function(e){  
            ...
            $.ajax({    
                     url:"<?php echo base_url(); ?>user/updateAd/",    
                     method:"POST",  
                     data:formData,  
                     beforeSend: function() {
                     ...
                     {  
                        ...
                        if(response['status']==1){ 
                            ...
                            setTimeout(function(){
                                $('#update_msg').html('');
                                $('#load').html('');
                                window.location.replace('user/adList');
                            },1000)
                        }
