...
<!-- MAIN CONTENT -->
        ...
        <div class="col-lg-10">
            ...
            <form id="masjidForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="row">                 
        ...
        <div class="col-sm-8">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input name="imam" class="form-control" type="text" placeholder="Imam Name" id="name" value="<?php if($userData->role_id==1): echo $userData->name; endif;?>" />
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input name="mutwalli" class="form-control" type="text" placeholder="Mutwalli Name" id="name" value="<?php if($userData->role_id==2): echo $userData->name; endif;?>" />
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input name="lat" class="form-control" type="text" placeholder="Latitude" id="latitude" value="" />
                </div> 
                <div class="col-sm-6">
                    <label for="lng" class="col-form-label">Longitude</label>
                    <input name="lng" class="form-control" type="text" placeholder="Longitude" id="longitude" value="" />
                </div>
                <div class="col-sm-6">
        ...
        <div class="form-group row"> 
                <div class="col-sm-9">
                <button type="submit" id="submit" class="btn btn-primary w-md m-b-5"><span id="load"></span>200 Pay & Add</button>
                <br>
	...
	$(document).ready(function(){
        ...
        $('#insertUserData').on('submit', function(e){  
            ...
            $.ajax({    
                     url:"<?php echo base_url(); ?>user/insertMasjid/",    
                     method:"POST",  
                     data:formData,  
                     beforeSend: function() {
                     ...
                     {  
                        ...
                        if(response['status']==1){
                            ...
                            setTimeout(function(){
                                $('#update_msg').html('');
                                window.location.replace('user/masjidList');
                            },1000)
                        }
...
$("#masjidForm").submit(function(e){
    e.preventDefault();
    var formData = new FormData(this);
    $.ajax({
        url: "<?= base_url('user/create_order'); ?>",
        type: "POST",
        dataType: "json",
        success:function(res){
            ...
            if(res.status){
                var options = {
                    ...
                    "amount": res.amount,
                    "currency": "INR",
                    "name": "Namaztimetable.com",
                    "description": "Masjid Payment",
                    ...
                    "handler": function(response){
                        formData.append('razorpay_order_id', res.order_id);
                        formData.append('razorpay_payment_id',response.razorpay_payment_id);
                        formData.append('razorpay_signature',response.razorpay_signature);
                        console.log('Payment success',formData);
                        $.ajax({
                            ...
                            success:function(saveRes){
                                if(saveRes.status){
                                    ...
                                    $('#update_msg').html('Masjid added successfully').css('color','green');
                                    window.location.href =
                                    "<?= base_url('user/masjidList'); ?>";
                                }else{
